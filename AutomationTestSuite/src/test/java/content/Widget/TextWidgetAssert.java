...
public class TextWidgetAssert {
  ...
  public void testText() throws Exception {
	    driver.get("http://test.per.smartfocus.com/#/content/xkOU20EpE6LSS3CNSeFb/vDJMPxI0ARgZ5C8k66Tb");
	    Thread.sleep(7000);
    ...
    // Text Widget Icon
    try {
      assertEquals("", driver.findElement(By.cssSelector("span.element-icon.type-text")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Text Widget Name
    try {
      assertEquals("Text", driver.findElement(By.xpath("//div[@id='site-wrapper']/div/div/div[2]/div/div[2]/div[3]/div/div/div/div/div/div/span[2]/span/span[2]")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Text Widget Name In Object Panel
    try {
      assertEquals("Text", driver.findElement(By.cssSelector("a.directory-item-title.type-layer > span")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Veriy Text Widget Name Appear In Property Header Section
    try {
      assertEquals("Text", driver.findElement(By.cssSelector("h2.panel-header-title")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // Text Widget Hint
    try {
      assertEquals("The 'Text' widget allows you to add a single line of text to your content.", driver.findElement(By.cssSelector("div.hint")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
    // 'Content Section'
    ...
    try {
      assertEquals("The 'Text' widget allows you to add a single line of text to your content.", driver.findElement(By.xpath("//div/div/div/span")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
